...
public class Welcome {
	...
	public static void main(String[] args) {
		...
		System.out.println(" 2. 장바구니 상품 목록 보기 \t5. 바구니의 항목 수량 줄이기");
		System.out.println(" 3. 장바구니 비우기 \t6. 바구니의 항목 삭제하기");
		...
		*/
		if (n < 1 || n > 9) {
			...
			case 1:
				...
				menuGuestInfo(userName, userMobile); // 고객 정보 출력 메서드 호출
				break;
			case 2:
	...
	public static void menuCartBill() throws CartException {
		...
		if(mCart.mCartCount == 0) 
			...
			if (str.toUpperCase().equals("Y")) { // 고객 정보와 동일한 경우
				...
				printBill(mUser.getName(), String.valueOf(mUser.getPhone()), address); // 배송을 위한 고객 정보(이름, 연락처, 주소)와 영수증 출력을 위한 printBill() 메서드 호출
			}
	...
	public static void setFileToBookList(ArrayList<Book> booklist) {
		try {
			FileReader fr = new FileReader("book.trxt");
			BufferedReader reader = new BufferedReader(fr);
